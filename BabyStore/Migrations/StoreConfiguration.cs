    ...
    internal sealed class StoreConfiguration : DbMigrationsConfiguration<BabyStore.DAL.StoreContext>
    {
        ...
        protected override void Seed(BabyStore.DAL.StoreContext context)
        {
            ...
            var products = new List<Product>
            {
                ...
                new Product { Name = "Orange and Yellow Lion", Description="Makes a squeaking noise", Price=1.99M,
                ...
                new Product { Name = "Reflux Medicine", Description="Helps to prevent milk regurgitation and sickness", Price=4.99M,
                            CategoryId =categories.Single( c => c.Name == "Medicine").ID },
                new Product { Name = "Black Pram and Pushchair System", Description="Convert from pram to pushchair, with raincover", Price=299.99M,
                ...
                new Product { Name = "Crib", Description="Wooden crib", Price=35.99M,
                            CategoryId = categories.Single(c => c.Name == "Sleeping").ID },
                new Product { Name = "Cot Bed", Description="Converts from cot into bed for older children", Price=149.99M,
                            CategoryId =categories.Single( c => c.Name == "Sleeping").ID },
